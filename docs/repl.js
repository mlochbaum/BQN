...
if (doc.doexplain) doc.doexplain.onclick = () => {
  if (explain===undefined) {
    let drawEval = run(
     ...
     ,[[0,1,0,32],[0,0,484,4],[0,0,571,3],[0,0,614,6],[0,0,717,3],[0,0,730,8],[0,0,954,3],[0,0,964,3],[0,0,980,4],[0,0,1031,3],[0,0,1056,4],[1,1,1153,2],[0,0,1183,3],[0,0,1197,29],[1,0,2010,5],[1,1,2022,2],[1,1,2054,2],[0,1,2084,4],[0,0,2274,15],[0,0,2572,5],[0,0,2654,3],[0,0,2705,3]]
    );
    explain = (s,c) => {
