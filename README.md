...
* [**New symbols**](https://mlochbaum.github.io/BQN/keymap.html) for built-in functionality make the syntactic role of every primitive instantly visible, and aim to be more consistent and intuitive.
